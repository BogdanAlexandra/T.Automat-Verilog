...
HD_PWD='C:/Users/Amalia/OneDrive/Desktop/CN/automat/automat.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log automat.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source automat.tcl
